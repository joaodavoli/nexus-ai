...
/* Esconde botão de colapsar/expandir */
...
/* ── IDENTIDADE ── */
.nexus-logo { font-size:1.2rem; font-weight:600; color:#111; letter-spacing:0.08em; }
.nexus-sub { font-size:0.68rem; color:#999; text-transform:uppercase; letter-spacing:0.05em; margin-bottom:14px; }
.divider { border-top:1px solid #e8e8e8; margin:12px 0; }
.section-label { font-size:0.65rem; color:#aaa; text-transform:uppercase; letter-spacing:0.1em; margin:12px 0 6px; }

/* ── BOTÕES ── */
.stButton > button {
    background:#fff !important; border:1px solid #e0e0e0 !important;
    color:#444 !important; border-radius:8px !important; font-size:0.8rem !important;
    white-space:normal !important; height:auto !important; padding:8px 12px !important;
    transition:all 0.15s !important;
}
.stButton > button:hover { border-color:#bbb !important; color:#111 !important; background:#f5f5f5 !important; }
.primary-btn > button { background:#111 !important; color:#fff !important; border:none !important; font-weight:500 !important; }
.primary-btn > button:hover { background:#333 !important; color:#fff !important; }
.danger-btn > button { background:transparent !important; border:1px solid #fca5a5 !important; color:#ef4444 !important; }
.danger-btn > button:hover { background:#fff5f5 !important; }

/* ── CHAT HEADER ── */
.chat-header { text-align:center; padding:60px 20px 36px; }
.chat-header h1 { font-size:1.9rem; font-weight:500; color:#111; margin-bottom:8px; }
.chat-header p { color:#999; font-size:0.82rem; font-weight:300; }

/* ── MENSAGENS ── */
div[data-testid="stChatMessage"] { background:transparent !important; }
.stMarkdown p, .stMarkdown li { color:#222; font-size:0.88rem; line-height:1.75; }
.stMarkdown h1,.stMarkdown h2,.stMarkdown h3 { color:#111; }
.stMarkdown strong { color:#111; }
.stMarkdown code { background:#f3f4f6; color:#1d4ed8; border-radius:4px; padding:2px 6px; font-size:0.82rem; }
.stMarkdown pre { background:#f8f9fa !important; border:1px solid #e8e8e8; border-radius:8px; padding:14px; }
.stMarkdown table { border-collapse:collapse; width:100%; font-size:0.82rem; }
.stMarkdown th { background:#f3f4f6; color:#555; padding:8px 12px; border:1px solid #e8e8e8; font-weight:500; }
.stMarkdown td { color:#333; padding:7px 12px; border:1px solid #f0f0f0; }

/* ── INPUTS ── */
.stTextInput > div > div > input {
    background:#fff !important; border:1px solid #e0e0e0 !important;
    color:#111 !important; border-radius:8px !important; font-size:0.85rem !important;
}
.stTextInput > div > div > input:focus { border-color:#999 !important; box-shadow:none !important; }
div[data-testid="stChatInput"] > div { background:#f7f7f7 !important; border:1px solid #e0e0e0 !important; border-radius:12px !important; }
div[data-testid="stChatInput"] textarea { color:#111 !important; background:transparent !important; }
.stChatFloatingInputContainer { background-color:#ffffff !important; padding-bottom:0 !important; }
[data-testid="stChatInputContainer"] { background-color:#ffffff !important; }
.stBottom, .stBottom > div { background-color:#ffffff !important; }
...
.history-title { font-size:0.78rem; color:#333; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }

/* ── AUTH PAGE ── */
.auth-logo { font-size:1.6rem; font-weight:600; color:#111; text-align:center; margin-bottom:4px; letter-spacing:0.1em; }
.auth-sub { font-size:0.75rem; color:#999; text-align:center; margin-bottom:24px; text-transform:uppercase; letter-spacing:0.08em; }

/* ── SETTINGS PAGE ── */
.settings-section { background:#f7f7f7; border:1px solid #e8e8e8; border-radius:10px; padding:18px; margin-bottom:14px; }
.settings-title { font-size:0.72rem; color:#999; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:12px; font-weight:500; }

/* ── SELECT / TABS ── */
div[data-baseweb="select"] > div { background:#fff !important; border-color:#e0e0e0 !important; color:#111 !important; }
div[data-baseweb="tab-list"] { background:#f7f7f7 !important; border-bottom:1px solid #e8e8e8 !important; }
button[data-baseweb="tab"] { color:#999 !important; }
button[data-baseweb="tab"][aria-selected="true"] { color:#111 !important; border-bottom:2px solid #111 !important; }

/* ── USER BADGE SIDEBAR ── */
.user-badge { background:#efefef; border:1px solid #e0e0e0; border-radius:8px; padding:8px 10px; margin-bottom:12px; }
.user-badge-name { color:#111; font-weight:500; font-size:0.82rem; }
.user-badge-email { color:#999; font-size:0.72rem; }
