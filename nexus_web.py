...
# render_css() é chamado aqui (nível de módulo) para rodar antes de tudo
# A função é definida abaixo mas Python permite isso pois o call real é no final
...
/* ── VARIÁVEIS INTERNAS DO STREAMLIT (mais importante) ── */
:root {{
    --text-color: {text} !important;
    --background-color: {bg} !important;
    --secondary-background-color: {sidebar_bg} !important;
    --primary-color: {text} !important;
    --font: 'Inter', sans-serif !important;
}}

/* ── FORÇA FUNDO E FONTE EM TUDO ── */
html, body, [data-testid="stAppViewContainer"], .stApp {{
    background-color: {bg} !important;
    color: {text} !important;
    font-family: 'Inter', sans-serif !important;
}}
p, span, label, h1, h2, h3, h4, h5, h6, li, td, th, a,
[data-testid="stMarkdownContainer"] *,
[data-testid="stText"],
[data-testid="stCaptionContainer"],
.stMarkdown *, .element-container *, .stTextInput label,
.stSelectbox label, .stTextArea label,
[class*="st-"] {{ color: {text} !important; }}
...
render_css()  # CSS antes de tudo — sobrescreve tema do Streamlit
main()
